// The 50 states (+ DC) — the spine of the location menu, the map page, and
// every state hub page. `slug` is the URL segment; `abbr` matches the two-letter
// `state:` field authors put in each review's front matter.
module.exports = [
